...
describe('EventService', () => {
  ...
  describe('getEventById', () => {
    ...
    it('should throw NotFoundError if event not found', async () => {
      ...
      await expect(EventService.getEventById(mockEventId)).rejects.toThrow(NotFoundError);
    });
  });
  ...
  describe('updateEvent', () => {
    ...
    it('should throw ValidationError for invalid ID', async () => {
      ...
      await expect(EventService.updateEvent('invalid-id', { name: 'Test' })).rejects.toThrow(ValidationError);
    });
    ...
    it('should throw NotFoundError if event not found', async () => {
      ...
      await expect(EventService.updateEvent(mockEventId, { name: 'Test' })).rejects.toThrow(NotFoundError);
    });
  });
  ...
  describe('deleteEvent', () => {
    it('should delete event successfully', async () => {
      ...
      (mongoose.Types.ObjectId.isValid as jest.Mock).mockReturnValue(true);
      (Event.findByIdAndDelete as jest.Mock).mockResolvedValue(mockDeletedEvent);
    ...
    it('should throw ValidationError for invalid ID', async () => {
      ...
      await expect(EventService.deleteEvent('invalid-id')).rejects.toThrow(ValidationError);
    });
    ...
    it('should throw NotFoundError if event not found', async () => {
      ...
      await expect(EventService.deleteEvent(mockEventId)).rejects.toThrow(NotFoundError);
    });
  });
